...
VIDEO_2_CLIPS = [
    ...
    },
    {
        ...
        "prompt": base_prompt(
            ...
            "calm. He gently places his smartphone face-up on his clean "
            "organized desk. CRITICAL: the smartphone screen is CLEARLY "
            "VISIBLE and TURNED ON throughout the entire shot, displaying "
            f"the app interface — {APP_UI_DESCRIPTION}But on this final "
            "screen, every card in the list now shows a GREEN 'VALIDÉ ✓' "
            "badge (instead of the orange 'À VALIDER'). The camera lingers "
            "on the phone screen briefly so the viewer clearly sees the "
            "completed list. Then he stretches his arms above his head in "
            "a satisfied 'mission accomplished' gesture. He picks up a "
            "coffee mug from the desk, sits down in his office chair, "
            "glances one last time at his smartphone (screen still visible "
            "and lit, showing the validated list) with a small proud "
            "closed-mouth smile. Hero final shot, golden-hour uplifting "
            "serene mood."
        ),
    },
]
