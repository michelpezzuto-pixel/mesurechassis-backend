...
<div class="flyer">
  <div class="card">
    ...
    <!-- HERO -->
    <div class="hero">
      <div class="hero-eyebrow">Création belge, par un menuisier belge, pour les menuisiers belges</div>
      <div class="hero-title">
        Une semaine ?<br>
        On vous fait passer<br>
        à <em>une journée.</em>
      </div>
      <div class="hero-sub">
    ...
    <div class="free-banner">
      <div class="free-banner-eyebrow">Pionniers belges - Application en phase bêta</div>
      <div class="free-banner-headline">100% GRATUIT</div>
      <div class="free-banner-detail">Toutes les fonctionnalités. Sans carte, sans engagement.</div>
    </div>
    ...
    <div class="args">
      <div class="arg">
        ...
        <div class="arg-title">Import IA</div>
        <div class="arg-desc">PDF, Excel ou photo du cahier des charges. L'IA lit tout.</div>
      </div>
      <div class="arg">
        <div class="arg-icon">▢</div>
        <div class="arg-title">14 formes</div>
        <div class="arg-desc">Carré, porte, trapèze, œil-de-bœuf, coulissant, cintré…</div>
      </div>
      <div class="arg">
        <div class="arg-icon">&#8595;</div>
        <div class="arg-title">6 exports</div>
        <div class="arg-desc">PDF client, Excel devis, CSV ERP. Directement du chantier.</div>
      </div>
      <div class="arg">
        <div class="arg-icon">&#8226;</div>
        <div class="arg-title">Hors-ligne</div>
        <div class="arg-desc">Cave, sous-sol, sans 4G : ça marche. Synchro auto au retour.</div>
      </div>
      <div class="arg">
        <div class="arg-icon">☁</div>
        <div class="arg-title">Sauvegarde</div>
        <div class="arg-desc">Photos jointes à chaque ouverture. Rien à réécrire au bureau.</div>
      </div>
      <div class="arg">
        <div class="arg-icon">🇧🇪</div>
        <div class="arg-title">100% belge</div>
        <div class="arg-desc">Support FR direct, serveurs en Belgique, conforme RGPD.</div>
      </div>
    </div>
...
<style>
  ...
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .flag {{
    background: linear-gradient(90deg, #000 33.33%, #FDDA24 33.33% 66.66%, #EF3340 66.66%);
