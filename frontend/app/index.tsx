    ...
    <SafeAreaView style={styles.flex} edges={["top", "bottom"]}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          {/* 🍎 Bandeau Apple Review supprimé (juillet 2026) : l'app est
           * officiellement validée par Apple — le compte démo
           * applereview@mesurechassis.com reste actif en base pour les
           * futures reviews de mises à jour (identifiants à renseigner
           * dans App Store Connect → App Review Information). */}
