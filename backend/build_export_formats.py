...
<style>
  * { box-sizing: border-box; -webkit-print-color-adjust: exact; }
  ...
  /* Highlights — Odoo & Vertuoza (logiciels devis pro) */
  .pill.pro {
    grid-column: 1 / -1;
  ...
  /* Logo Odoo — carré violet aubergine avec "odoo" en blanc */
  .badge.odoo-logo {
    background: linear-gradient(135deg, #A03A6E, #714B67);
    color: #fff;
    font-weight: 900;
    font-size: 30px;
    letter-spacing: -1px;
  ...
  /* Logo Vertuoza — carré bleu marine avec motif + "V" */
  .badge.vertuoza-logo {
    background: #14133E;
    color: #fff;
    display: flex; align-items: center; justify-content: center;
  ...
  .badge.vertuoza-logo::before {
    content: "";
    position: absolute; top: 24px; left: 22px; right: 22px;
    height: 4px;
    background: #fff;
    border-radius: 2px;
    box-shadow:
      0 8px 0 -1px rgba(255,255,255,0.85),
      0 16px 0 -2px rgba(255,255,255,0.65);
    transform: skewX(-8deg);
  }
  .badge.vertuoza-logo::after {
    content: "V";
  ...
  .pill.odoo     { animation: bounce-in 700ms cubic-bezier(.15,1.4,.4,1) 2400ms forwards; }
  .pill.vertuoza { animation: bounce-in 700ms cubic-bezier(.15,1.4,.4,1) 3000ms forwards; }
...
<body>
  ...
  <div class="grid">
    ...
    <div class="pill pro odoo">
      <div class="badge odoo-logo">odoo</div>
      <span>Odoo</span>
      <span class="tag">Devis</span>
    </div>
    <div class="pill pro vertuoza">
      <div class="badge vertuoza-logo"></div>
      <span>Vertuoza</span>
      <span class="tag">Devis</span>
    </div>
  </div>
